...
namespace CinecorePlayer2025
{
    ...
    public sealed class DirectShowUnifiedEngine : IPlaybackEngine
    {
        ...
        public DirectShowLib.IFilterGraph2? GetGraph()
        {
            try
            {
                return _graph as DirectShowLib.IFilterGraph2;
            }
        ...
        private void ConnectAudioPath()
        {
            try
            {
                ...
                var srcA = FindPin(srcSplitter, PinDirection.Output, DirectShowLib.MediaType.Audio)
            ...
            try
            {
                ...
                try
                {
                    ...
                    while (e.Next(1, arr, IntPtr.Zero) == 0)
                    {
                        ...
                        try
                        {
                            if (mt.majorType == DirectShowLib.MediaType.Texts)
                                return true;
