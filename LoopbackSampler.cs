...
namespace CinecorePlayer2025
{
    ...
    internal sealed class LoopbackSampler : IDisposable
    {
        ...
        public bool Start(string? renderDeviceId = null)
        {
            ...
            try
            {
                _cap = string.IsNullOrEmpty(renderDeviceId)
                     ? new WasapiLoopbackCapture()
                     : new WasapiLoopbackCapture(new MMDeviceEnumerator().GetDevice(renderDeviceId));
        ...
        public void Stop()
        {
            ...
            // opzionale: azzera completamente lo stato
            ResetState();
        }
